...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/node_modules/warning/warning.js';

import { plugin } from '../core/umiExports';

export * from 'F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/node_modules/react-intl';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/src/locales/en-US.js')),...((locale) => locale.__esModule ? locale.default : locale)(require('F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/src/pages/DashBoard/locales/en-US.js')),
    },
    locale: 'en-US',
    antd: {
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/src/locales/pt-BR.js')),...((locale) => locale.__esModule ? locale.default : locale)(require('F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/src/pages/DashBoard/locales/pt-BR.js')),
    },
    locale: 'pt-BR',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/src/locales/zh-CN.js')),...((locale) => locale.__esModule ? locale.default : locale)(require('F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/src/pages/DashBoard/locales/zh-CN.js')),
    },
    locale: 'zh-CN',
    antd: {
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/src/locales/zh-TW.js')),...((locale) => locale.__esModule ? locale.default : locale)(require('F:/py_project/scitc_pr/VueDjangoAntdProBookShop/xadmin/src/pages/DashBoard/locales/zh-TW.js')),
    },
    locale: 'zh-TW',
    antd: {
